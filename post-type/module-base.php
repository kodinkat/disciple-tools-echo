...
/**
 * Class Disciple_Tools_Echo_Base
 * Load the core post type hooks into the Disciple Tools system
 */
class Disciple_Tools_Echo_Base extends DT_Module_Base {
     ...
     * @var string
     */
    public $post_type = "echo";
    public $module = "echo_base";
    public $single_name = 'Echo';
    public $plural_name = 'Echoes';
