...
class Disciple_Tools_Echo_Chart_Template extends DT_Metrics_Chart_Base
{
    public $base_slug = 'disciple-tools-echo-metrics'; // lowercase
    public $base_title = "Echo Metrics";
