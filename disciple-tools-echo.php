 ...
 * 2. @todo Rename the `disciple-tools-echo.php file.
...
class Disciple_Tools_Echo {
    ...
    private function __construct() {
         ...
         */
        if ( $is_rest && strpos( dt_get_url_path(), 'disciple_tools_echo' ) !== false ) {
 ...
 * @link https://github.com/DiscipleTools/disciple-tools-echo/wiki/Configuring-Remote-Updating-System
 *
