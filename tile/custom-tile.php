...
class Disciple_Tools_Echo_Tile {
    ...
    public function dt_details_additional_tiles( $tiles, $post_type = "" ) {
        if ( $post_type === "contacts" ) {
            $tiles["disciple_tools_echo"] = [ "label" => __( "Echo", 'disciple_tools' ) ];
        }
    ...
    public function dt_custom_fields( array $fields, string $post_type = "" ) {
        ...
        if ( $post_type === "contacts" ) {
            ...
            /**
             * Echo conversation id tags field
             */
            $fields['dt_echo_convo_ids'] = [
                'name'        => __( 'Echo - Conversation IDs', 'disciple_tools' ),
                'description' => _x( 'An historical list of all incoming Echo conversation ids.', 'Optional Documentation', 'disciple_tools' ),
                'type'        => 'tags',
                'default'     => [],
                'tile'        => 'disciple_tools_echo',
                'icon'        => get_template_directory_uri() . '/dt-assets/images/tag.svg'
            ];

            /**
             * Echo sources key/label
             */
            $source_key = 'echo';
    ...
    public function dt_add_section( $section, $post_type ) {
         ...
         */
        if ( $post_type === "contacts" && $section === "disciple_tools_echo" ) {
            /**
...
Disciple_Tools_Echo_Tile::instance();
