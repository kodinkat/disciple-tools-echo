...
Disciple_Tools_Echo_Magic_Link::instance();

class Disciple_Tools_Echo_Magic_Link extends DT_Magic_Url_Base {
    ...
    public $post_type = 'echo'; // @todo set the post type this magic link connects with.
    private $meta_key = '';
